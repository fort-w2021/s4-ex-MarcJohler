...
animals_gaze <- function(object) {
  paste(class(object)[1],
        ...
        " reflection in a puddle", sep = "")
}

## define methods...
# ... for two general animals meeting each other (used only for callNextMethod())
setMethod("meet", signature(object1 = "animal", object2 = "animal"),
...
setMethod("meet", signature(object1 = "prey", object2 = "prey"),
          function(object1, object2) {
...
setMethod("meet", signature(object1 = "predator", object2 = "predator"),
          function(object1, object2) {
            # if both animals are the same, the animal is gazing at itself
            if (identical(object1, object2)) {
              return(animals_gaze(object1))
...
setMethod("meet", signature(object1 = "predator", object2 = "prey"),
          function(object1, object2) {
            # if both animals are the same, the animal is gazing at itself
            if (identical(object1, object2)) {
              return(animals_gaze(object1))
...
# ...and vice versa
setMethod("meet", signature(object1 = "prey", object2 = "predator"),
          function(object1, object2) {
